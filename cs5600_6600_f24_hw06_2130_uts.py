...
class cs5600_6600_f21_hw02_2130_uts(unittest.TestCase):
    ...
    '''
    def test_run_duts_cnn_hive_weight_forecaster_for_2130(self):
        run_duts_forecaster('WH_TH_HOURLY_MEANS_USDA_ARS_TUCSON_AZ_2022.csv',
                            'cnn', 0.7, 2130, 10, 6, 2, 'wh')
    '''

    '''
    def test_run_duts_cnn_hive_temp_forecaster_for_2130(self):
        run_duts_forecaster('WH_TH_HOURLY_MEANS_USDA_ARS_TUCSON_AZ_2022.csv',
                            'cnn', 0.7, 2130, 10, 6, 2, 'th')        
    '''

    '''
    def test_run_duts_lstm_hive_weight_forecaster_for_2130(self):
        run_duts_forecaster('WH_TH_HOURLY_MEANS_USDA_ARS_TUCSON_AZ_2022.csv',
                            'lstm', 0.7, 2130, 10, 6, 2, 'wh')
    '''

    '''
    def test_run_duts_lstm_hive_temp_forecaster_for_2130(self):
        run_duts_forecaster('WH_TH_HOURLY_MEANS_USDA_ARS_TUCSON_AZ_2022.csv',
                            'lstm', 0.7, 2130, 10, 6, 2, 'th')
    '''
